...
<!--                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="work_phone"id="inputEmail3" placeholder="Work Phone" maxlength="11">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <label class="checkbox-inline" class="col-sm-4 control-label">
                                                    <input type="checkbox"  name="check" id="inlineCheckbox1" value="yes" required="required">All the information is Right
                                                </label>
                                            </div>
                                        </div>
...
<!--                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    ...
                                                                    <img src="images/<?php echo $value->image_name; ?>" alt="<?php echo $value->image_name; ?>" class="form-control" style="height: 200px;">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                ...
                <ul class="pagination">
                    ...
                    if ($num > 1) {
                        for ($a = 1; $a <= $num; $a++) {
                            ?>
                            <li class="">
                                <a href="index.php?page_id=<?php echo $a; ?>"><span><?php echo $a; ?></span><span class="sr-only">(current)</span></span></a>
                            </li>
                        <?php }
                        ?>
                        <li class="">
                            <a href="index.php?page_id=<?php echo $num ?>"><span>>> <span class="sr-only">(current)</span></span></a>
                        </li>
                        <?php
                    } else {
                        for ($a = 1; $a <= $num; $a++) {
                            ?>
                            <li class="">
                                <a href="index.php?page_id=<?php echo $a; ?>"><span><?php echo $a; ?> <span class="sr-only">(current)</span></span></a>
                            </li>
                            <?php
                        }
                    }
