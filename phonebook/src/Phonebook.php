...
//            return $data;
//        } else {
            $query = "SELECT * FROM tbl_info ORDER BY info_id DESC";
...
//        Requered::debug($data);
        ...
        if (isset($data['upload'])) {
            ...
            if ($error > 0) {
                ...
                $query = "UPDATE `tbl_info` SET `info_id`='" . $id . "',`fname`='" . $fname . "',`lname`='" . $lname . "',`nname`='" . $nname . "',`image_name`='" . $image . "',`mobile`='" . $mobile . "',`home_phone`='" . $home_phone . "',`work_phone`='" . $work_phone . "',`address`='" . $address . "',`city`='" . $city . "',`country`='" . $country . "',`zip_code`='" . $zip_code . "' WHERE `info_id`=" . $id;
//        Requered::debug($query);
                $result = mysql_query($query);
